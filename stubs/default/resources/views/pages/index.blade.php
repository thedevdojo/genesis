                    ...
                    <div class="grid grid-cols-1 gap-2 p-6 bg-opacity-25 lg:pt-0 md:grid-cols-2 lg:gap-4 lg:gap-y-1 lg:p-8">
                        <div>
                            <a href="https://laravel.com/docs" target="_blank" class="relative flex items-center px-4 py-3 mt-3 border border-gray-200 rounded-lg bg-gray-50 group gap-x-2.5 hover:bg-white">
                                ...
                                <span class="flex flex-col justify-center h-full opacity-70 group-hover:opacity-100 text-[0.65rem]">
                                    <span class="relative flex items-center mt-0 mb-0.5 text-sm font-semibold leading-none text-gray-900">Laravel</span>
                                    <span href="https://laravel.com/docs" class="inline-flex items-center font-normal leading-none text-gray-700">View the Docs</span>
                                </span>
                            </a>
                        </div>
                        <div>
                            <a href="https://livewire.laravel.com/docs" target="_blank" class="relative flex items-center px-4 py-3 mt-3 border border-gray-200 rounded-lg bg-gray-50 group gap-x-2.5 hover:bg-white">
                                <span class="flex items-center justify-center flex-none w-8 h-8">
                                ...
                                <span class="flex flex-col justify-center h-full opacity-70 group-hover:opacity-100 text-[0.65rem]">
                                    <span class="relative flex items-center mt-0 mb-0.5 text-sm font-semibold leading-none text-gray-900">Livewire</span>
                                    <span href="https://laravel.com/docs" class="inline-flex items-center font-normal leading-none text-gray-700">View the Docs</span>
                                </span>
                            </a>
                        </div>
                        <div>
                            <a href="https://alpinejs.dev/docs" target="_blank" class="relative flex items-center px-4 py-3 mt-3 border border-gray-200 rounded-lg bg-gray-50 group gap-x-2.5 hover:bg-white">
                                <span class="flex items-center justify-center flex-none w-8 h-8">
                                ...
                                <span class="flex flex-col justify-center h-full opacity-70 group-hover:opacity-100 text-[0.65rem]">
                                    <span class="relative flex items-center mt-0 mb-0.5 text-sm font-semibold leading-none text-gray-900">Alpine</span>
                                    <span href="https://laravel.com/docs" class="inline-flex items-center font-normal leading-none text-gray-700">View the Docs</span>
                                </span>
                            </a>
                        </div>
                        <div>
                            <a href="https://tailwindcss.com/docs" target="_blank" class="relative flex items-center px-4 py-3 mt-3 border border-gray-200 rounded-lg bg-gray-50 group gap-x-2.5 hover:bg-white">
                                ...
                                <span class="flex flex-col justify-center h-full opacity-70 group-hover:opacity-100 text-[0.65rem]">
                                    <span class="relative flex items-center mt-0 mb-0.5 text-sm font-semibold leading-none text-gray-900">Tailwind</span>
                                    <span href="https://laravel.com/docs" class="inline-flex items-center font-normal leading-none text-gray-700">View the Docs</span>
                                </span>
                            </a>
                        </div>
                        <div>
                            <a href="https://github.com/laravel/folio" target="_blank" class="relative flex items-center px-4 py-3 mt-3 border border-gray-200 rounded-lg bg-gray-50 group gap-x-2.5 hover:bg-white">
                                <span class="flex items-center justify-center flex-none w-8 h-8">
                                ...
                                <span class="flex flex-col justify-center h-full opacity-70 group-hover:opacity-100 text-[0.65rem]">
                                    <span class="relative flex items-center mt-0 mb-0.5 text-sm font-semibold leading-none text-gray-900">Laravel Folio</span>
                                    <span href="https://laravel.com/docs" class="inline-flex items-center font-normal leading-none text-gray-700">View the Docs</span>
                                </span>
                            </a>
                        </div>
                        <div>
                            <a href="https://livewire.laravel.com/docs/volt" target="_blank" class="relative flex items-center px-4 py-3 mt-3 border border-gray-200 rounded-lg bg-gray-50 group gap-x-2.5 hover:bg-white">
                                <span class="flex items-center justify-center flex-none w-8 h-8">
                                ...
                                <span class="flex flex-col justify-center h-full opacity-70 group-hover:opacity-100 text-[0.65rem]">
                                    <span class="relative flex items-center mt-0 mb-0.5 text-sm font-semibold leading-none text-gray-900">Laravel Volt</span>
                                    <span href="https://laravel.com/docs" class="inline-flex items-center font-normal leading-none text-gray-700">View the Docs</span>
                                </span>
                            </a>
                        </div>
