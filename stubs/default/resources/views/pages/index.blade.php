    ...
    @volt('home')
        <div class="flex flex-col items-center justify-center min-h-screen py-10" x-cloak>
            ...
            <div class="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <h1 class="mt-5 text-2xl font-bold leading-9 text-center text-gray-700 dark:text-gray-200">
                    Welcome to Genesis
                </h1>
            ...
            <div x-data="{ showMoreInfo: $persist(true).as('genesis.show-more-info') }" class="mt-5 dark:shadow-2xl relative sm:mt-8 sm:border dark:sm:bg-gray-950/50 sm:shadow-sm sm:rounded-md border-gray-200/70 dark:border-gray-200/10 sm:mx-auto sm:w-full sm:max-w-md">
                
                <div class="flex flex-col px-8 py-4 space-y-3 border-b sm:py-8 sm:space-y-0 sm:space-x-5 sm:flex-row sm:bg-white dark:sm:bg-transparent dark:border-gray-200/10 border-gray-200/70 sm:rounded-t-lg sm:px-10">
                ...
                <div @click="showMoreInfo=!showMoreInfo" class="flex items-center justify-between w-full px-10 py-3 text-xs font-medium text-left text-gray-400 dark:hover:text-gray-200 border-b cursor-pointer hover:bg-gray-100/40 group sm:bg-white/30 dark:sm:bg-gray-950/40 dark:border-gray-200/10 border-gray-200/70">
                ...
                <div x-show="showMoreInfo" class="sm:bg-opacity-25 sm:bg-gray-200 dark:sm:bg-opacity-100 dark:bg-gray-950/60 dark:border-white/10 border-b" x-collapse>
                    <div class="col-span-2 p-6 pb-0 lg:pb-0 lg:p-8">
                        <p class="text-xs leading-relaxed text-left text-gray-500 dark:text-gray-300 -translate-y-2">
                ...
                <div class="col-span-2 px-10 py-6 bg-white/30 dark:bg-transparent sm:px-10 sm:py-5">
                    <p class="text-xs leading-relaxed text-left text-gray-500 dark:text-gray-300">
