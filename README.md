...
APP_URL will be set differently according to how you install laravel.  Some might use the laravel installer come user composer.  Vite will is serving on http://localhost:5173 while other parts of the app are using http://[::1]:5173. 
